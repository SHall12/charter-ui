...
/* TODO: Make this a component
    Prop takes in a chord w/
        Name
        Bar? start->end, with range 0-6, end>start and start!=end
        List of strings:
            Fret, finger, square?
        Starting position
    Returns a div w/ canvas 

    Can save w/ const dataURL = canvas.toDataURL()
*/
...
export default function ChordBoxImage(name, chord, fingers, size) {
